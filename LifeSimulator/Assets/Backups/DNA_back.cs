...
public class DNA_back {
    ...
    {
        return (genes.Length / GetGeneLength()) - (genes.Length % GetGeneLength());
    }
    ...
    {
        string newDNA = MutateLength(genes, MutateProb);
    ...
    public string GetGene(int nmb)
    {
        ...
        return genes.Substring(start, geneLength);
    }
    ...
    {
        int b = (int)char.GetNumericValue(genes[at]);
        return b;
    }
